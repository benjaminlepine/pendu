...
// const dico = ['ANGLE', 'ARMOIRE', 'BANC', 'BUREAU', 'CABINET', 'CARREAU'];
const dico = ['MANDARINE', 'MANDARINE'];

class App extends Component {
    constructor(){
        super();
        let inithiddenword = dico[Math.floor(Math.random() * dico.length)];
        let initusertry = "".padStart(inithiddenword.length , '_');
        this.state = {
